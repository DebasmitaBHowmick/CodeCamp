...
//no need to add post and headers manually in axios:
    //try {
    //const response = await axios.post("http://localhost:8000/register", authDetail);
    // catch (error) {
