  ...
  return (
   <section className="text-xl text-center max-w-4xl mx-auto my-10 py-5 dark:text-slate-100 border dark:border-slate-700 rounded">
        <div className="my-5">
            ...
            <p>Thank you user {data.userInfo.name} for order!</p>
            <p>Your Order ID: {data.userInfo.id}</p>          
        </div>
        <div className="my-5">
            <p>Your order is confirmed.</p>
            <p>Please check your mail ({data.userInfo.email}) for the eBook.</p>
            <p className="my-5">Payment ID: {data.userInfo.payment_id}</p>
        </div>
